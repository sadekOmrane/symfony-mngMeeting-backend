 ...
 */
final class Version20221029214923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955EF1A9D84 FOREIGN KEY (notification_id) REFERENCES notification (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD CONSTRAINT FK_BF5476CA4E9B7368 FOREIGN KEY (reunion_id) REFERENCES reservation (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
